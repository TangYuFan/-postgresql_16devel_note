...
static void BufferSync(int flags)
{
    ...
    printf("【log】bufmgr.c BufferSync()\n");
...
{
    printf("【log】bugmgr.c BgBufferSync() 后台bgwriter处理脏页flush\n");
...
static int SyncOneBuffer(int buf_id, bool skip_recently_used, WritebackContext *wb_context)
{
    ...
    printf("【log】bufmgr.c SyncOneBuffer() 持久化一个Page, buf_id=%d,skip=%d\n",buf_id,skip);
...
{
    printf("【log】bufmgr.c CheckPointBuffers() 将共享缓冲池中的所有脏页刷盘\n");
