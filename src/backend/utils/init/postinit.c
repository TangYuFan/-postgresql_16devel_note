...
InitializeMaxBackends(void)
{
    ...
    printf("【log】postinit.c InitializeMaxBackends() 设置后台进程最大数 MaxConnections=%d,autovacuum_max_workers=%d,max_worker_processes=%d,max_wal_senders=%d 总共 MaxBackends=%d\n",MaxConnections,autovacuum_max_workers,max_worker_processes,max_wal_senders,MaxBackends);
...
//    printf("【log】postinit.c BaseInit()\n");
			 ...
			 char *out_dbname)
{
    ...
    printf("【log】postinit.c InitPostgres() 客户端进程初始化 dbname=%s,user=%s\n",in_dbname,username);
