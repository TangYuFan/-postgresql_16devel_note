...
//    printf("【log】postgres.c ReadCommand() 读取客户端指令:%d\n",result);
...
exec_simple_query(const char *query_string)
{
    ...
    printf("【log】postgres.c exec_simple_query() 执行query查询:\n",query_string);
...
PostgresMain(const char *dbname, const char *username)
{
    ...
    printf("【log】postgres.c PostgresMain() 开始客户端处理 dbname=%s,user=%s\n",dbname,username);
	...
	for (;;)
	{
		...
		switch (firstchar)
		{
			case 'Q':			/* simple query */
				{
                    ...
                    printf("【log】postgres.c firstchar='Q'\n");
			...
			case 'P':			/* parse */
				{
                    ...
                    printf("【log】postgres.c firstchar='P'\n");
			...
			case 'B':			/* bind */
                ...
                printf("【log】postgres.c firstchar='B'\n");
			...
			case 'E':			/* execute */
				{
                    ...
                    printf("【log】postgres.c firstchar='E'\n");
			...
			case 'F':			/* fastpath function call */
                ...
                printf("【log】postgres.c firstchar='F'\n");
			...
			case 'C':			/* close */
				{
                    printf("【log】postgres.c firstchar='C'\n");
			...
			case 'D':			/* describe */
				{
                    ...
                    printf("【log】postgres.c firstchar='D'\n");
			...
			case 'H':			/* flush */
                ...
                printf("【log】postgres.c firstchar='H'\n");
			...
			case 'S':			/* sync */
                ...
                printf("【log】postgres.c firstchar='S'\n");
			...
			case EOF:
                ...
                printf("【log】postgres.c firstchar='EOF'\n");
			...
			case 'X':
                ...
                printf("【log】postgres.c firstchar='X'\n");
