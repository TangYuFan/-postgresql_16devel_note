...
{
    printf("【log】origin.c CheckPointReplicationOrigin() 对重放的 remote_lsn 执行每个复制源的进度检查点。 确保我们在检查点 (local_lsn) 中引用的所有事务实际上都在磁盘上。\n");
...
StartupReplicationOrigin(void)
{
    ...
    printf("【log】origin.c StartupReplicationOrigin()\n");
